...
resource "azurerm_virtual_network" "redteam" {
  ...
  depends_on = [azurerm_network_security_group.RedTeamSG1,
...
resource "azurerm_subnet" "dmz" {
  ...
  depends_on = [azurerm_network_security_group.RedTeamSG1,azurerm_virtual_network.redteam]
}
...
resource "azurerm_subnet" "webtier" {
  ...
  depends_on = [azurerm_network_security_group.RedTeamSG2,azurerm_virtual_network.redteam]
}
